...
class Snake(object):
    def __init__(self):
        self.x = (FRAME_WIDTH - SNAKE_SIZE)/2
        self.y = (FRAME_HEIGHT - SNAKE_SIZE)/2
        self.length = 1
    ...
    def draw(self, win):
        self.x = (self.x + self.x_vel) % FRAME_WIDTH
        self.y = (self.y + self.y_vel) % FRAME_HEIGHT
...
class Food(object):
    ...
    @classmethod
    def random(cls):
        return Food(random.randint(0, FRAME_WIDTH) // SNAKE_SIZE * SNAKE_SIZE + SNAKE_SIZE//2,
                    random.randint(0, FRAME_HEIGHT) // SNAKE_SIZE * SNAKE_SIZE + SNAKE_SIZE//2)
...
def main():
    ...
    pygame.draw.rect(win, (255,255,255), (150,200, 200, 100))
    display_text(win, 'START', 150, 200, 40, (0,0,0))
    ...
    pygame.draw.rect(win, (255,0,0), (150,200, 200, 100))
    display_text(win, 'DED', 150, 200, 40, (0,0,0))
    pygame.display.update()
